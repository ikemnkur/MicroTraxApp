          ...
          <Box>
            ...
            <Box sx={{ textAlign: 'center', mt: 3 }}>
              <button
                ...
                style={{
                  ...styles.button,
                  backgroundColor: currency ? '#4caf50' : '#666',
        ...
        return (
          <Box>
            ...
            <form onSubmit={handleOrderSubmit} style={styles.form}>
              ...
              <div style={styles.formGroup}>
                <label>Full Name:<span style={styles.required}>*</span></label>
                <input
                  type="text"
                  name="name"
              ...
              <div style={styles.formGroup}>
                <label>Email Address:<span style={styles.required}>*</span></label>
                <input
                  type="email"
                  name="email"
              ...
              <div style={styles.formGroup}>
                <label>Your Wallet Address:<span style={styles.required}>*</span></label>
                <input
                  type="text"
                  name="walletAddress"
              ...
              <div style={styles.uploadSection}>
                <label style={styles.uploadLabel}>Payment Screenshot (Optional):</label>
    ...
    <Container sx={{ py: 4, position: 'relative', minHeight: '100vh' }}>
      ...
      <Box sx={{
        ...
        <IconButton
          ...
          sx={{
            backgroundColor: currentStep === 0 ? 'rgba(255, 255, 255, 0.1)' : '#ffd700',
            color: currentStep === 0 ? 'rgba(255, 255, 255, 0.3)' : '#000',
            width: { xs: 40, sm: 50 },
            height: { xs: 40, sm: 50 },
            '&:hover': {
              backgroundColor: currentStep === 0 ? 'rgba(255, 255, 255, 0.1)' : '#ffed4e',
            },
            boxShadow: currentStep === 0 ? 'none' : '0 4px 15px rgba(255, 215, 0, 0.3)'
          }}
        >
      ...
      <Box sx={{
        ...
        <IconButton
          ...
          sx={{
            backgroundColor: currentStep === totalSteps - 1 ? 'rgba(255, 255, 255, 0.1)' : '#ffd700',
            color: currentStep === totalSteps - 1 ? 'rgba(255, 255, 255, 0.3)' : '#000',
            width: { xs: 40, sm: 50 },
            height: { xs: 40, sm: 50 },
            '&:hover': {
              backgroundColor: currentStep === totalSteps - 1 ? 'rgba(255, 255, 255, 0.1)' : '#ffed4e',
            },
            boxShadow: currentStep === totalSteps - 1 ? 'none' : '0 4px 15px rgba(255, 215, 0, 0.3)'
          }}
        >
      ...
      >
        <CardContent sx={{ width: '100%', p: { xs: 2, sm: 4 } }}>
        ...
        {Array.from({ length: totalSteps }, (_, index) => (
          <Box
            ...
            sx={{
              ...
              height: { xs: 8, sm: 12 },
              borderRadius: '50%',
              backgroundColor: index === currentStep ? '#ffd700' : 'rgba(255, 255, 255, 0.3)',
              cursor: 'pointer',
              transition: 'all 0.3s ease',
              '&:hover': {
                backgroundColor: index === currentStep ? '#ffed4e' : 'rgba(255, 255, 255, 0.5)',
                transform: 'scale(1.2)'
              },
              boxShadow: index === currentStep ? '0 0 10px rgba(255, 215, 0, 0.5)' : 'none'
            }}
          />
        ))}
      </Box>
